    ...
    <div className='flex flex-col items-center space-y-6 border border-t-black'>
      ...
      <div className='flex justify-center space-x-6 space-y-8'>
        ...
        <Link to='/wwp-collection'>
          <button className='px-4 md:px-16 py-4 mb-5 text-sm font-semibold rounded-lg shadow-lg transition duration-300 ease-in-out border border-black-100 bg-white text-black hover:bg-black hover:text-white focus:outline-none focus:ring-4 focus:ring-indigo-500 focus:ring-opacity-50'>
            WWP Collection
          </button>
        </Link>
      </div>
